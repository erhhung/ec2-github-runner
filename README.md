...
- Added options to specify the type and size of the **root EBS volume** (see `root-volume-type` and `root-volume-size` inputs).
...
| `root-volume-type`                                                                                                                                                           | Optional. Used only with the `start` mode. | Root volume type. The default value is `gp3`.                                                                                                                                                                                                                                                                                         |
| `root-volume-size`                                                                                                                                                           | Optional. Used only with the `start` mode. | Root volume size in GiB. The default value is `'10'`.                                                                                                                                                                                                                                                                                 |
    ...
    steps:
      ...
      - name: Start EC2 runner
        ...
        with:
          ...
          root-volume-size: '10'      # optional, default is '10' GiB
